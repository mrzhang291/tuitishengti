...
<table><tr><td colspan="8">选择题</td><td colspan="3">多选题</td></tr><tr><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td><td>10</td><td>11</td></tr><tr><td>D</td><td>C</td><td>D</td><td>B</td><td>C</td><td>A</td><td>B</td><td>B</td><td>ACD</td><td>ACD</td><td>BCD</td></tr></table>

填空题：12. 3-e 13. -1 14. (0,2)

11.[详解]解：对于 A 选项， $f(x)=\frac{x}{\ln x}$ 的定义域为 $(0,1)\cup(1,+\infty)$ ，所以 A 选项错误；
...
![](images/f2a5d4b70fe93c00aa85998c39c867ede08280b60f538f8179be5be6e81be684.jpg)
...
![](images/de1c9123b24f99c03731b7ed3bac6929f3d7eda83c99bd5915dacc6e233660a1.jpg)

由图像可知，k > e，所以 D 选项正确.

13.[详解]不妨取 $\forall x_{1}>x_{2}\in(0,+\infty)$ ，由 $\frac{f(x_{1})-f(x_{2})}{x_{1}-x_{2}}<a$ 可得 $f(x_{1})-f(x_{2})<a(x_{1}-x_{2})$ ，即 $f(x_{1})-ax_{1}<f(x_{2})-ax_{2}$ ，
令 $g(x)=f(x)-ax$ ，可得 $\forall x_{1}>x_{2}\in(0,+\infty)$ ， $g(x_{1})<g(x_{2})$ ，
...
14. (0,2)[详解] $f(x)=x^{3}+x-\sin x$ ，得 $f(-x)=(-x)^{3}-x-\sin(-x)=-\left(x^{3}+x-\sin x\right)=-f(x)$
...
15.[详解]（1）当 $a = 1$ 时， $f(x) = x^2 - 3x\ln x, f(1) = 1$ 。 $f'(x) = 2x - 3\ln x - 3, f'(1) = -1.$
...
又因为 $g'(x)=\frac{3(1-\ln x)}{x^{2}}$ ，当 0<x<e 时， $g'(x)>0$ ；当 x>e 时， $g'(x)<0$ 。
...
![](images/c42c40867cde12ed71dd986c9dc3d2ec9ba4c5c666b76b5eb1ce482027934270.jpg)
...
16.[详解]（1）当 $a = \mathbf{e}$ 时， $h(x) = \mathrm{e}^x - \frac{\mathrm{e}}{x}, h'(x) = \mathrm{e}^x + \frac{\mathrm{e}}{x^2}$ ，所以 $h'(1) = 2\mathrm{e}$ ，又 $h(1) = 0$
...
所以 $\varphi(x)$ 的图象与直线 y=a 在区间 $\left(\frac{x_{1}}{\mathrm{e}^{a}},x_{1}\right),\left(x_{1},x_{2}\right),\left(x_{2},ax_{2}\right)$ 内各有一个交点，因此 a>e 符合题意.
综上，a 的取值范围是 $(\mathrm{e},+\infty)$ .
